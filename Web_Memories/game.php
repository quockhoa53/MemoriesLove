                            ...
                            <div class="text">
                                ...
                                <div class="group-container">
                                    <div class="form-toggle">
                                        <button id="questionBtn" onclick="showQuestion()"><b>Danh sách câu hỏi</b></button>
                                        <button id="resultBtn" onclick="showResult()"><b>Thành tích gần đây</b></button>
                                    </div>
                                </div>
                                <button id="toggleContent" onclick="toggleContent()" class="toggle-btn"><b><i class="bi bi-chevron-up"></i></b></button>
                                <div class="form-container" id="contentContainer">
                                    <!-- Form Danh sách câu hỏi -->
                                    <form id="listquestion-form" class="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                        <h5 class="title-love"><b>CÂU HỎI CỦA BẠN</b></h5>
                                        <hr>
                                        <?php
                                        ...
                                        if ($cauhoi !== null && count($cauhoi) > 0) {
                                            foreach ($cauhoi as $q) {
                                                if (is_array($q) && isset($q['ID_CH'], $q['NOIDUNG'])) {
                                                    ...
                                                    echo '<div class="title-love1"><b> Câu ' . htmlspecialchars($count) . ': ' . htmlspecialchars($q['NOIDUNG']) . '</b></div>';
                                                    ...
                                                    if ($answer !== null) {
                                                        echo '<div class="ngang"><b>Đáp án:</b> ' . htmlspecialchars($answer) . '</div>';
                                                    } else {
                                                    ...
                                                    echo '<div class="action"><b>Hành động:</b><span><button type="button" class="delete-btn" data-id="' . htmlspecialchars($q['ID_CH']) . '" data-toggle="modal" data-target="#confirmDeleteModal">
                                    ...
                                    <form id="result-form" class="form hidden" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                        <h5 class="title-love"><b>ĐIỂM TÌNH YÊU: <?php echo htmlspecialchars($datacustomer['DIEMTINHYEU']); ?></b></h5>
                                        <br>
                                                    ...
                                                    if (isset($thanhtich) && count($thanhtich) > 0) {
                                                        ...
                                                        foreach ($thanhtich as $tt) {
                                                            if ($tt != null && count($tt) > 0) {
                                                                if ($index == 1) echo '<tr style="color: #e91e63;">';
                                                                else echo '<tr>';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleContent() {
                if (contentContainer.style.display === 'none') {
                    ...
                    toggleButton.innerHTML = '<b><i class="bi bi-chevron-up"></i></b>';
                } else {
                    contentContainer.style.display = 'none';
                    toggleButton.innerHTML = '<b><i class="bi bi-chevron-down"></i></b>';
                }
            }
