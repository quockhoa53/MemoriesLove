    ...
    <main class="main-content">
        <div class="container">
            ...
            <?php } elseif (!empty($ngayhenho)) { ?>
                ...
                <br>
                <p style="margin-left: 20px;">Bạn đang hẹn hò với <span><b><?php echo !empty($datayourlove['HOTEN']) ? $datayourlove['HOTEN'] : ''; ?></b></span></p>
                <p style="margin-left: 20px;">Ngày yêu: <b><?php echo htmlspecialchars($ngayhenho); ?></b></p>
                <script>
                    const startDate = new Date('<?php echo $ngayhenho_tmp; ?>');
                    const currentDate = new Date();
                    const timeDiff = Math.abs(currentDate.getTime() - startDate.getTime());
                    const daysDiff = Math.ceil(timeDiff / (1000 * 3600 * 24));
                    document.write('<p style="margin-left: 20px;">Đã yêu nhau được <b>' + daysDiff + '</b> ngày</p>');
                </script>
                <br>
                <div class="group">
                    <button id="showCalendarBtn" style="margin-left: 20px;">Xem lịch</button>
                    <br>
                    ...
                    <div id="date-memories" style="display: none;">
                        <b><label id="datememories" class="text-date"></label></b>
                    </div>
                    <br>
                    <div id="calendar-container" style="display: none;"></div><br>
                </div>
            <?php } else { ?>
                <p class="title-love"><b>Mỗi khoảnh khắc bên người bạn yêu là một trang ký ức quý giá</b></p>
                <div class="row">
                    <div class="col-md-4 d-flex justify-content-end">
                        <img src="/web_memories/images/caytraitim.svg">
                    </div>
                    <div class="col-md-4 justify-content-center">
                        <div class="group-fa">
                            <p style="font-size:1.2em;"><b>Nhập ID người yêu của bạn ❤</b></p>
                            <form id="accountForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                <div class="form-group">
                                    <label for="codelove" class="left"><b>ID:</b></label>
                                    <input type="text" id="codelove" name="codelove" required>
                                </div>
                                <div class="form-group">
                                    <label for="date" class="left"><b>Ngày yêu:</b></label>
                    ...
                    <div class="col-md-4 d-flex justify-content-start">
                        <img src="/web_memories/images/caytraitim-nguoc.svg">
                    </div>
                </div>
                <script>
