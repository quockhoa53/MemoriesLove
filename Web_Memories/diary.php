            ...
            <?php } else { ?>
                <div class="row justify-content-center align-items-center text-center">
                    <div class="col-12 col-md-3 d-flex justify-content-end align-items-center">
                        <img src="/web_memories/images/thienthantinhyeu.gif" class="w-50" alt="Gif image">
                    </div>
                    <div class="col-12 col-md-3 d-flex justify-content-start align-items-center">
                        <p class="mb-0 highlight-text title-nolove">Hôm nay của bạn thế nào?</p>
                    </div>
                    <div class="col-12 col-md-3 d-flex justify-content-start align-items-center">
                        <input type="button" id="btn-pink" value="Viết nhật ký" onclick="showwritediaryForm()">
                    </div>
                </div>
                <hr>
                <div class="group">
                    <form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 d-flex justify-content-center">
                                <input type="submit" id="btn-blue" value="Lọc nhật ký">
                            </div>
                        </div>
                    </form>
                    <br>
